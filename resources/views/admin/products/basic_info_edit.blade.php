                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div>
                                                <select class="form-control select2" id="primary_category_id" name="primary_category_id">
                                                    ...
                                                    <option value="{{ $category->id }}" @if($category->id == old('primary_category_id', $product->primary_category_id)) selected @endif>{{ $category->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="product_type3" name="product_type" class="form-check-input" value="customise" {{ check_uncheck($product->product_type,'customise') }}>
